...
describe :EventsDispatcher do
  ...
  context :initialize do
    it 'sets the current processed command as sequence zero' do
      ...
      EventsDispatcher.new events_command_builder
    end
  end
  ...
  context :dispatch do
    ...
    describe 'when the event has an invalid payload' do
      it 'returns false' do
        ...
        dispatcher = EventsDispatcher.new(events_command_builder)
    ...
    describe 'when the event has a valid payload' do
      ...
      let(:dispatcher) { EventsDispatcher.new(events_command_builder, unprocessed_events_manager) }
